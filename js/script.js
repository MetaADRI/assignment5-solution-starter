$(function () { // Same as document.addEventListener("DOMContentLoaded"...
  ...
  // Load a random category for the specials
  function loadRandomSpecials() {
    $ajaxUtils.sendGetRequest(allCategoriesUrl, function(categories) {
      ...
      document.querySelector("#specials-tile a").setAttribute("onclick", "$dc.loadMenuItems('" + randomCategory.short_name + "');");
    }, true);
  }

  // Expose the $dc namespace to global scope
  global.$dc = {
